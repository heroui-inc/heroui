 ...
 *
 * Usage: node apps/docs-cn/scripts/build-theme-presets.mjs
 * Output: apps/docs-cn/src/styles/theme-presets.css
 */
...
const banner = `/* ============================================================================
   Auto-generated theme presets for docs-cn.
   Run: node apps/docs-cn/scripts/build-theme-presets.mjs
   ============================================================================ */\n`;

...
const THEMES: ThemeOption[] = [
  {id: "default", image: defaultTheme, label: "默认"},
  {id: "sky", image: skyTheme, label: "天空"},
  {id: "lavender", image: lavenderTheme, label: "薰衣草"},
  {id: "mint", image: mintTheme, label: "薄荷"},
  ...
  {id: "rabbit", image: rabbitTheme, label: "兔子"},
];
      ...
      <Popover>
        <Popover.Trigger>
          ...
          >
            ...
            <span className="hidden sm:inline">{showAvatar ? current.label : "主题"}</span>
          </Button>
        </Popover.Trigger>

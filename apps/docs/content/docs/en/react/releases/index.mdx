...
Patch release: `Table.SortableColumnHeader`, toast ViewTransition serialization, broader Fieldset disabled propagation, Modal and AlertDialog scroll fixes, ScrollShadow scrollbar mask fixes, Table RTL positioning, and React Aria Components 1.18.

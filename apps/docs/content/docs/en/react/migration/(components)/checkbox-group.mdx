...
**v3:** Compound Checkbox components with `Checkbox.Button`, `Checkbox.Control`, and `Checkbox.Indicator`
...
- Update Checkbox children to use compound component structure (`Checkbox.Button`, `Checkbox.Control`, `Checkbox.Indicator`)

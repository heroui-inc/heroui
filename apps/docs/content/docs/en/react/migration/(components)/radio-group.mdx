...
**v3:** Compound Radio components with `Radio.Button`, `Radio.Control`, and `Radio.Indicator`

### 3. Description Handling

**v2:** Used `description` prop on individual `Radio` components  
**v3:** Use `Description` component as a sibling of `Radio.Button`
...
- Replace `description` prop on Radio with `Description` component as a sibling of `Radio.Button`

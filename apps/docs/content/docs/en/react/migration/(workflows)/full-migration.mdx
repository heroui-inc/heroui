...
Check the [Theming documentation](/docs/react/getting-started/theming) for available CSS variables.
...
3. Check out the [styling guide](/docs/react/getting-started/styling)
4. Learn about [composition patterns](/docs/react/getting-started/composition)

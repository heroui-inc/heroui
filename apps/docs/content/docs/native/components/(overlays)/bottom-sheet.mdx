...
See the complete example: [bottom-sheet-with-text-input.tsx](https://github.com/heroui-inc/heroui-native/blob/rc/example/src/components/bottom-sheet/with-text-input.tsx)

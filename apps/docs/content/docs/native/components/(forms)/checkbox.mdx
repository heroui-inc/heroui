...
| `inSurface`       | `"default" \| "secondary" \| "tertiary"`                                                              | `undefined` | Whether checkbox is in a surface background (auto-detected if not set)    |
...
| `inSurface`      | `"default" \| "secondary" \| "tertiary" \| undefined`                         | Whether checkbox is in a surface background                    |

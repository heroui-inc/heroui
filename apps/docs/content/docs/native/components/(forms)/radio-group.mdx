...
| `inSurface`   | `"default" \| "secondary" \| "tertiary"`                    | `undefined` | Whether the radio group is in a surface                                                     |
...
| `inSurface`       | `"default" \| "secondary" \| "tertiary"`                                                                    | `undefined` | Whether the radio item is in a surface (auto-detected if not set)           |
...
**Note:** The `inSurface` state is automatically provided via context from the parent RadioGroup.Item component.
...
| `isDisabled`  | `boolean` | Whether the radio item is disabled   |
| `isInvalid`   | `boolean` | Whether the radio item is invalid    |
| `inSurface` | `"default" \| "secondary" \| "tertiary"` | Whether the radio item is in a surface |

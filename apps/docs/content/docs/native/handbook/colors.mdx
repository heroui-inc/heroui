...
HeroUI Native's color system is built on top of Tailwind CSS v4's theme. When you import `heroui-native/styles`, it uses Tailwind's built-in color palettes and maps them to semantic variables.

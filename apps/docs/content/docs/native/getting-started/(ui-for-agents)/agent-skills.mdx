...
Supports Claude Code, Cursor, OpenCode, Codex CLI, and Antigravity. The installer automatically detects your IDE and installs the skill.
</span>

### Usage

Skills are **automatically discovered** by your AI assistant.
...
- Accessibility best practices for React Native

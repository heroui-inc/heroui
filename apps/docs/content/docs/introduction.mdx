...
<img className="w-full object-cover rounded-xl shadow-border h-[360px]" src="https://heroui-assets.nyc3.cdn.digitaloceanspaces.com/docs/docs-intro-cover.jpg" alt="HeroUI v3 Introduction" />

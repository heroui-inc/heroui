...
HeroUI supports multiple ways to use components. All patterns are equivalent, choose what fits your codebase.
...
// Single components work directly  (recommended)
<Button>Click me</Button>

// Named components
<ButtonRoot>Click me</ButtonRoot>

// Compound components support dot notation (recommended)
<Alert>
  <Alert.Icon />
  <Alert.Content>

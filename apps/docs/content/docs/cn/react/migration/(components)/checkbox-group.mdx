...
**v3：** 复合 Checkbox 组件，由 `Checkbox.Button`、`Checkbox.Control` 与 `Checkbox.Indicator` 组成
...
- 将 Checkbox 子项更新为复合组件结构（`Checkbox.Button`、`Checkbox.Control`、`Checkbox.Indicator`）

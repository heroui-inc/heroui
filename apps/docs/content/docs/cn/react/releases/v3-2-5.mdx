---
title: v3.2.5
description: 补丁版本：Toast 支持堆叠并在悬停时展开，新增 Select.ClearButton 与 Tabs align 变体，从 @heroui/react 再导出 Pressable、Focusable、OverlayTriggerStateContext 与 DisclosureStateContext，并将 React Aria 升级到 1.21.0；同时修复嵌套 data-theme token、Shadow DOM 主题、原生 :focus-visible 焦点环、浮层层级，以及 ScrollShadow、Table、Drawer、NumberField、Accordion、Label 与 Tag 的问题。
github:
  pull: 6792
---

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/accordion",
    yarn: "yarn add @vezham/accordion",
    pnpm: "pnpm add @vezham/accordion",
    bun: "bun add @vezham/accordion"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Accordion, AccordionItem} from "@vezham/react";',
    individual: 'import {Accordion, AccordionItem} from "@vezham/accordion";',
  }}
/>

...
export function CustomStyles() {
  return (
    <Accordion.Root className="bg-surface-secondary w-full max-w-md rounded-2xl" variant="elevated">
...
| `variant` | `"default" \| "elevated"` | `"default"` | The visual variant of the accordion |

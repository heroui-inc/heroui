...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/dropdown",
    yarn: "yarn add @vezham/dropdown",
    pnpm: "pnpm add @vezham/dropdown",
    bun: "bun add @vezham/dropdown"
  }}
/>
...
```jsx
import {Dropdown, DropdownMenu, DropdownTrigger, DropdownItem, Button} from "@vezham/react";

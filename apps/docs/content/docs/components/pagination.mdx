...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/pagination",
    yarn: "yarn add @vezham/pagination",
    pnpm: "pnpm add @vezham/pagination",
    bun: "bun add @vezham/pagination"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Pagination, PaginationItem, PaginationCursor} from "@vezham/react";',
    individual:
      'import {Pagination, PaginationItem, PaginationCursor} from "@vezham/pagination";',
  }}
/>

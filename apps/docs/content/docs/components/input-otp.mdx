...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/input-otp",
    yarn: "yarn add @vezham/input-otp",
    pnpm: "pnpm add @vezham/input-otp",
    bun: "bun add @vezham/input-otp",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {InputOtp} from "@vezham/react";',
    individual: 'import {InputOtp} from "@vezham/input-otp";',
  }}
/>

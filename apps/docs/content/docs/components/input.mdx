...
function CustomInput() {
  return (
    <div className="flex flex-col gap-2">
      ...
      <Input
        id="custom-input"
        className="rounded-xl border border-border/70 bg-content1 px-4 py-2 text-sm shadow-sm focus-visible:border-primary"
...
@layer components {
  .input {
    @apply rounded-lg border border-border bg-content1 px-4 py-2 text-sm shadow-sm transition-colors;

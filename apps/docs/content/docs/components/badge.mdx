...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/badge",
    yarn: "yarn add @vezham/badge",
    pnpm: "pnpm add @vezham/badge",
    bun: "bun add @vezham/badge"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Badge} from "@vezham/react";',
    individual: 'import {Badge} from "@vezham/badge";',
  }}
/>

...
<ImportTabs
  commands={{
    main: 'import {RangeCalendar, CalendarCellContent, CalendarCellHeader, CalendarCellBody} from "@heroui/react";',
    individual: 'import {RangeCalendar, CalendarCellContent, CalendarCellHeader, CalendarCellBody} from "@heroui/calendar";'
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/user",
    yarn: "yarn add @vezham/user",
    pnpm: "pnpm add @vezham/user",
    bun: "bun add @vezham/user"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {User} from "@vezham/react";',
    individual: 'import {User} from "@vezham/user";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/chip",
    yarn: "yarn add @vezham/chip",
    pnpm: "pnpm add @vezham/chip",
    bun: "bun add @vezham/chip"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Chip} from "@vezham/react";',
    individual: 'import {Chip} from "@vezham/chip";',
  }}
/>

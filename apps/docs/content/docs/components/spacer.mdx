...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/spacer",
    yarn: "yarn add @vezham/spacer",
    pnpm: "pnpm add @vezham/spacer",
    bun: "bun add @vezham/spacer"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Spacer} from "@vezham/react";',
    individual: 'import {Spacer} from "@vezham/spacer";',
  }}
/>

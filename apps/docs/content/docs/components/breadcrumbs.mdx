...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/breadcrumbs",
    yarn: "yarn add @vezham/breadcrumbs",
    pnpm: "pnpm add @vezham/breadcrumbs",
    bun: "bun add @vezham/breadcrumbs"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Breadcrumbs, BreadcrumbItem} from "@vezham/react";',
    individual: 'import {Breadcrumbs, BreadcrumbItem} from "@vezham/breadcrumbs";',
  }}
/>

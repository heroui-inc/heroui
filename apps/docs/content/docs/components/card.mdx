...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/card",
    yarn: "yarn add @vezham/card",
    pnpm: "pnpm add @vezham/card",
    bun: "bun add @vezham/card"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Card, CardHeader, CardBody, CardFooter} from "@vezham/react";',
    individual: 'import {Card, CardHeader, CardBody, CardFooter} from "@vezham/card";',
  }}
/>

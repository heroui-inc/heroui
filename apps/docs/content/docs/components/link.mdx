...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/link",
    yarn: "yarn add @vezham/link",
    pnpm: "pnpm add @vezham/link",
    bun: "bun add @vezham/link"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Link} from "@vezham/react";',
    individual: 'import {Link} from "@vezham/link";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/radio",
    yarn: "yarn add @vezham/radio",
    pnpm: "pnpm add @vezham/radio",
    bun: "bun add @vezham/radio"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {RadioGroup, Radio} from "@vezham/react";',
    individual: 'import {RadioGroup, Radio} from "@vezham/radio";',
  }}
/>

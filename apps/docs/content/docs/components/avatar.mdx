...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/avatar",
    yarn: "yarn add @vezham/avatar",
    pnpm: "pnpm add @vezham/avatar",
    bun: "bun add @vezham/avatar"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Avatar, AvatarGroup, AvatarIcon} from "@vezham/react";',
    individual: 'import {Avatar, AvatarGroup, AvatarIcon} from "@vezham/avatar";',
  }}
/>

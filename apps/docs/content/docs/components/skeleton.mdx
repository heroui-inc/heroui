...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/skeleton",
    yarn: "yarn add @vezham/skeleton",
    pnpm: "pnpm add @vezham/skeleton",
    bun: "bun add @vezham/skeleton"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Skeleton} from "@vezham/react";',
    individual: 'import {Skeleton} from "@vezham/skeleton";',
  }}
/>

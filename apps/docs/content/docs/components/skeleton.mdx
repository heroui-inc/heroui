...
You can set a default animation type for all Skeleton components in your application by defining the `--skeleton-default-animation-type` CSS variable:
...
|------|------|---------|-------------|
| `animationType` | `"shimmer" \| "pulse" \| "none"` | `"shimmer"` or CSS variable | The animation type for the skeleton. Can be globally configured via `--skeleton-default-animation-type` CSS variable |

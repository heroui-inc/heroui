...
<PackageManagers
  commands={{
    npm: "npm install @internationalized/date@3.13.0",
    yarn: "yarn add @internationalized/date@3.13.0",
    pnpm: "pnpm add @internationalized/date@3.13.0",
  }}
/>
...
<PackageManagers
  commands={{
    npm: "npm install @internationalized/date@3.13.0 @react-aria/i18n@3.13.0",
    yarn: "yarn add @internationalized/date@3.13.0 @react-aria/i18n@3.13.0",
    pnpm: "pnpm add @internationalized/date@3.13.0 @react-aria/i18n@3.13.0",
  }}
/>

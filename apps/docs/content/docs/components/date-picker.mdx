...
<ImportTabs
  commands={{
    main: 'import {parseAbsoluteToLocal} from "@heroui/react";',
    individual: 'import {parseAbsoluteToLocal} from "@heroui/internationalized-date";',
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {I18nProvider} from "@heroui/react";',
    individual: 'import {I18nProvider} from "@heroui/react-aria-i18n";',
  }}
/>

...
<APITable
  data={[
    ...
    },
    {
      ...
      description: "Allows to set custom class names for the date-picker slots.",
      default: "-"
    },
    {
      attribute: "dateInputClassNames",
      type: `Partial<Record<"base"｜ "label"｜ "inputWrapper"｜ "innerWrapper"｜ "input"｜ "helperWrapper"｜ "description"｜ "errorMessage", string>>`,

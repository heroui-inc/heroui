...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/alert",
    yarn: "yarn add @vezham/alert",
    pnpm: "pnpm add @vezham/alert",
    bun: "bun add @vezham/alert",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Alert} from "@vezham/react";',
    individual: 'import {Alert} from "@vezham/alert";',
  }}
/>

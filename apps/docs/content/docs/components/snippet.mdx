...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/snippet",
    yarn: "yarn add @vezham/snippet",
    pnpm: "pnpm add @vezham/snippet",
    bun: "bun add @vezham/snippet"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Snippet} from "@vezham/react";',
    individual: 'import {Snippet} from "@vezham/snippet";',
  }}
/>

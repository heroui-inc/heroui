...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/progress",
    yarn: "yarn add @vezham/progress",
    pnpm: "pnpm add @vezham/progress",
    bun: "bun add @vezham/progress"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {CircularProgress} from "@vezham/react";',
    individual: 'import {CircularProgress} from "@vezham/progress";',
  }}
/>

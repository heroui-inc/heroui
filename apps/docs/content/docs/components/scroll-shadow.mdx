  ...
  data={[
    {
      attribute: "size",
      type: "number",
      description: "The shadow-sm size in pixels.",
      default: "40"
    },
    {
      attribute: "offset",
      type: "number", 
      description: "The scroll offset to show the shadow-sm in pixels.",
      default: "0"
    },
    {
    ...
    },
    {
      attribute: "isEnabled",
      type: "boolean",
      description: "Whether the shadow-sm is enabled or not.",
      default: "true"
    },
    {
      attribute: "visibility",
      type: "ScrollShadowVisibility",
      description: "The shadow-sm visibility. (controlled)",
      default: "auto"
    }
  ]}
/>
  ...
  data={[
    {
      ...
      description: "Callback invoked when the shadow-sm visibility changes.",
      default: "-"
    }
  ]}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/scroll-shadow",
    yarn: "yarn add @vezham/scroll-shadow",
    pnpm: "pnpm add @vezham/scroll-shadow",
    bun: "bun add @vezham/scroll-shadow"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {ScrollShadow} from "@vezham/react";',
    individual: 'import {ScrollShadow} from "@vezham/scroll-shadow";',
  }}
/>

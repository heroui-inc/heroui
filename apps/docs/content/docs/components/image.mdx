...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/image",
    yarn: "yarn add @vezham/image",
    pnpm: "pnpm add @vezham/image",
    bun: "bun add @vezham/image"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Image} from "@vezham/react";',
    individual: 'import {Image} from "@vezham/image";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/switch",
    yarn: "yarn add @vezham/switch",
    pnpm: "pnpm add @vezham/switch",
    bun: "bun add @vezham/switch"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Switch} from "@vezham/react";',
    individual: 'import {Switch} from "@vezham/switch";',
  }}
/>

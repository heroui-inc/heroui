...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/checkbox",
    yarn: "yarn add @vezham/checkbox",
    pnpm: "pnpm add @vezham/checkbox",
    bun: "bun add @vezham/checkbox"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {CheckboxGroup, Checkbox} from "@vezham/react";',
    individual: 'import {CheckboxGroup, Checkbox} from "@vezham/checkbox";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/slider",
    yarn: "yarn add @vezham/slider",
    pnpm: "pnpm add @vezham/slider",
    bun: "bun add @vezham/slider"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Slider} from "@vezham/react";',
    individual: 'import {Slider} from "@vezham/slider";',
  }}
/>

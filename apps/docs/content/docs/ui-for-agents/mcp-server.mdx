...
The MCP server currently supports **@heroui/react v3** only and [stdio transport](https://modelcontextprotocol.io/specification/2025-06-18/basic/transports#stdio) and is published at `@heroui/react-mcp` on npm.
...
<div className="flex items-center gap-3 mb-4">
  <a
    href="cursor://anysphere.cursor-deeplink/mcp/install?name=heroui-react&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsIkBoZXJvdWkvbWNwQGxhdGVzdCJdfQ=="
...
```bash
claude mcp add heroui-react -- npx -y @heroui/mcp@latest
```
...
- [npm Package](https://www.npmjs.com/package/@heroui/mcp@latest)

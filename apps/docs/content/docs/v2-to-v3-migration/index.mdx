...
<Callout type="info">
  For comprehensive styling migration guidance, including utility classes, component styles, and visual differences, see the [Styling Migration Guide](/docs/v2-to-v3-migration/styling).
</Callout>

...
Once configured, AI assistants can automatically access migration guides and help you migrate your components more efficiently. The MCP server provides tools like `get_migration_guide`, `list_migration_guides`, and `get_component_guides` that can be used to fetch relevant migration information for your specific needs.

**Repository:** The Migration MCP server code is available at [`heroui-inc/heroui-mcp`](https://github.com/heroui-inc/heroui-mcp/tree/main/apps/heroui-v3-migration-mcp).
...
| Ripple | ❌ | ❌ Removed | [View guide →](/docs/v2-to-v3-migration/ripple) |

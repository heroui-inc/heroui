...
If you're using an AI assistant to help with migration, see the [Agent Migration Guide](/docs/v2-to-v3-migration/agent-guide) for instructions on how assistants should guide users through prompts.
...
- Handle in-progress/planned components (Badge, Breadcrumbs, Calendar, DateInput, DatePicker, Drawer, Pagination, Progress, ScrollShadow, Table, Toast) - replace with HTML elements until v3 components are available

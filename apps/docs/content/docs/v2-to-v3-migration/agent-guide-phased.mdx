...
<include>./index.mdx#step-1-update-dependencies</include>

**Agent Note**: These dependency updates can be done before switching HeroUI (won't break project). However, the HeroUI package switch should only happen AFTER all component code is migrated.

## Configuration Changes

<include>./index.mdx#step-2-update-theming-configuration</include>

## Remove HeroUIProvider

<include>./index.mdx#step-3-remove-herouiprovider</include>
...
<include>./index.mdx#step-5-update-component-imports</include>
...
<include>./index.mdx#step-6-update-custom-theme-overrides</include>

## Styling Migration

<include>./index.mdx#step-8-styling-migration</include>

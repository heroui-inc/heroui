...
- See the [Avatar documentation](/docs/components/avatar)
- Check [Avatar migration guide](/docs/v2-to-v3-migration/avatar)

**For styling guidance:**
- See the [Styling documentation](/docs/handbook/styling)
- Check [Tailwind CSS documentation](https://tailwindcss.com/docs) for flexbox utilities

...
<Callout type="info">
  Refer to the [v3 Slider documentation](/docs/components/slider) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from HeroUI v2.
</Callout>
...
- See the [API Reference](/docs/components/slider#api-reference)
- Check [interactive examples](/docs/components/slider#usage)

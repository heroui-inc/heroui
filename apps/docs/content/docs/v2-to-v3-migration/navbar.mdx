...
- Check [Tailwind CSS documentation](https://tailwindcss.com/docs) for layout utilities

**For mobile menu patterns:**
- See [MDN Navigation Patterns](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/patterns/navigation)
- Check [WAI-ARIA Navigation Example](https://www.w3.org/WAI/ARIA/apg/patterns/disclosure/examples/disclosure-navigation/)

...
2. **`implement-migration`**: Implement component migrations incrementally with checkpoints for user approval. Use this to migrate components phase by phase. No arguments required.
3. **`migrate-styling-phase`**: Get styling migration instructions after component migration is complete. Use this after switching to v3 dependencies. No arguments required.
...
1. **Update React to v19** (if not already)
   ...
   - Commit separately: "chore: update React to v19"

2. **Update Tailwind CSS to v4** (if not already)
   - This can be done before switching HeroUI
   - Test that project still works
   - Commit separately: "chore: update Tailwind CSS to v4"
...
2. **Fix remaining issues**
   - Project should now compile (may have runtime issues)
...
4. **Guide user to invoke `migrate-styling-phase` prompt**
   - Prompt includes styling migration instructions

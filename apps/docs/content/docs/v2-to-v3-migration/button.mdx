...
**v3:** `ButtonGroup` component continues to exist with enhanced prop inheritance. See the [ButtonGroup migration guide](/docs/v2-to-v3-migration/button-group) for details.
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ...
    <ButtonGroup>
      ...
      <Button size="sm" variant="primary">Three</Button>
    </ButtonGroup>
    ```
  </Tab>
  <Tab value="v3">
...
**Note:** ButtonGroup in v3 supports enhanced prop inheritance. See the [ButtonGroup migration guide](/docs/v2-to-v3-migration/button-group) for more details.
...
11. **ButtonGroup Available**: ButtonGroup continues to exist with enhanced prop inheritance - see [ButtonGroup migration guide](/docs/v2-to-v3-migration/button-group)

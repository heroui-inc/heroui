...
<Callout type="info">
  Refer to the [v3 Tabs documentation](/docs/components/tabs) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from HeroUI v2.
</Callout>
...
- See the [API Reference](/docs/components/tabs#api-reference)
- Check [interactive examples](/docs/components/tabs#usage)

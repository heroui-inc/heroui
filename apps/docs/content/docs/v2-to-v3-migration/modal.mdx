...
<Callout type="info">
  For detailed migration from `useDisclosure` to `useOverlayState`, see the [Hooks Migration Guide](/docs/v2-to-v3-migration/hooks).
</Callout>
...
<Callout type="info">
  For detailed `useDisclosure` → `useOverlayState` migration guide, see the [Hooks Migration Guide](/docs/v2-to-v3-migration/hooks).
</Callout>

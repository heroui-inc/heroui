...
<Callout type="info">
  Refer to the [v3 Spinner documentation](/docs/components/spinner) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from HeroUI v2.
</Callout>
...
- See the [API Reference](/docs/components/spinner#api-reference)
- Check [interactive examples](/docs/components/spinner#usage)

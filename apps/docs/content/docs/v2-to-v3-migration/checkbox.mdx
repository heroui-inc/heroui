...
<Callout type="info">
  Refer to the [v3 Checkbox documentation](/docs/components/checkbox) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from HeroUI v2.
</Callout>
...
- See the [API Reference](/docs/components/checkbox#api-reference)
- Check [interactive examples](/docs/components/checkbox#usage)

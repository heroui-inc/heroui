...
When used inside a [Surface](/docs/components/surface) component, SearchField automatically applies in-surface styling.

<ComponentPreview name="search-field-in-surface" />
...
- `.search-field__group--in-surface` – Applied when used inside a Surface component

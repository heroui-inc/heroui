...
| `inSurface` | `"default" \| "secondary" \| "tertiary"` | - | Whether the field is in a surface (auto-detected when inside Surface). |
...
| `inSurface` | `"default" \| "secondary" \| "tertiary"` | - | Whether the input is in a surface (auto-detected when inside Surface). |

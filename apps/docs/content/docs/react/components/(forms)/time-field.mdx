...
When used inside a [Surface](/docs/components/surface) component, TimeField and its child DateInputGroup automatically apply in-surface styling.

<ComponentPreview name="time-field-in-surface" />
...
| `inSurface` | `"transparent" \| "default" \| "secondary" \| "tertiary"` | `false` | Whether the input is displayed in a surface (affects styling) |

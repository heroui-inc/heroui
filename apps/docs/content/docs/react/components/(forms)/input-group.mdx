...
When used inside a [Surface](/docs/components/surface) component, InputGroup automatically applies in-surface styling. You can also manually control this with the `inSurface` prop.
...
@layer components {
  ...
  .input-group--in-surface {
    @apply bg-in-surface shadow-none;
  }
}
```
...
- `.input-group--in-surface` – Variant for use in surface backgrounds
...
| Prop | Type | Default | Description |
|------|------|---------|-------------|
| `inSurface` | `"transparent" \| "default" \| "secondary" \| "tertiary"` | - | Whether the group is displayed in a surface background. Automatically detected when inside a Surface component. |
...
| `inSurface` | `"transparent" \| "default" \| "secondary" \| "tertiary"` | - | Whether the input is displayed in a surface background. |
...
|------|------|---------|-------------|
| `className` | `string` | - | CSS classes for styling. |
| `inSurface` | `"transparent" \| "default" \| "secondary" \| "tertiary"` | - | Whether the textarea is displayed in a surface background. |
| `value` | `string` | - | Current value (controlled). |
| `defaultValue` | `string` | - | Default value (uncontrolled). |
| `placeholder` | `string` | - | Placeholder text. |

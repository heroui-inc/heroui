...
| Prop | Type | Default | Description |
|------|------|---------|-------------|
| `inSurface` | `"default" \| "secondary" \| "tertiary"` | - | Whether the group is displayed in a surface background. Automatically detected when inside a Surface component. |
...
| `inSurface` | `"default" \| "secondary" \| "tertiary"` | - | Whether the input is displayed in a surface background. |
...
|------|------|---------|-------------|
| `className` | `string` | - | CSS classes for styling. |
| `inSurface` | `"default" \| "secondary" \| "tertiary"` | - | Whether the textarea is displayed in a surface background. |
| `value` | `string` | - | Current value (controlled). |
| `defaultValue` | `string` | - | Default value (uncontrolled). |
| `placeholder` | `string` | - | Placeholder text. |

...
When used inside a [Surface](/docs/components/surface) component, TextField and its child Input/TextArea components automatically apply in-surface styling.

<ComponentPreview name="text-field-in-surface" />

...
When used inside a [Surface](/docs/components/surface) component, TextArea automatically applies in-surface styling.
...
| `inSurface` | `"transparent" \| "default" \| "secondary" \| "tertiary"` | `false` | Whether the textarea is displayed in a surface (affects styling) |

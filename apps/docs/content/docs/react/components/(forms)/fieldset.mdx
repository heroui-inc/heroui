...
When used inside a [Surface](/docs/components/surface) component, form controls within Fieldset automatically apply in-surface styling.

<ComponentPreview name="fieldset-in-surface" />

...
When used inside a [Surface](/docs/components/surface) component, RadioGroup automatically applies in-surface styling.
...
| `inSurface` | `"transparent" \| "default" \| "secondary" \| "tertiary"` | `false` | Whether the radio group is displayed in a surface (affects styling) |

...
<ComponentPreview
  name="disclosure-group-custom-render-function"
/>
...
| `render` | `DOMRenderFunction<keyof React.JSX.IntrinsicElements, DisclosureGroupRenderProps>` | - | Overrides the default DOM element with a custom render function.|

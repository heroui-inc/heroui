...
- `.select__trigger--in-surface` - In surface variant styling
...
| `inSurface`   | `"transparent" \| "default" \| "secondary" \| "tertiary"`                               | -                  | Whether the select is displayed in a surface component   |

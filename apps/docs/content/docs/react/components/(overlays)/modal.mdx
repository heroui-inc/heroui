...
<ComponentPreview
  name="modal-custom-render-function"
/>
...
| `render` | `DOMRenderFunction<keyof React.JSX.IntrinsicElements, ModalRenderProps>` | - | Overrides the default DOM element with a custom render function.|

...
<ComponentPreview
  name="toast-custom-render-function"
/>
...
| `render` | `DOMRenderFunction<keyof React.JSX.IntrinsicElements, ToastRenderProps>` | - | Overrides the default DOM element with a custom render function.|
...
| `className` | `string` | - | Additional CSS classes |
| `render` | `DOMRenderFunction<keyof React.JSX.IntrinsicElements, ToastContentRenderProps>` | - | Overrides the default DOM element with a custom render function.|

...
<ComponentPreview
  name="spinner-custom-render-function"
/>
...
| `render` | `DOMRenderFunction<keyof React.JSX.IntrinsicElements, SpinnerRenderProps>` | - | Overrides the default DOM element with a custom render function.|

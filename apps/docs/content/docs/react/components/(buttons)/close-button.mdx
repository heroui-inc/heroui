...
<ComponentPreview
  name="close-button-custom-render-function"
/>
...
| `render` | `DOMRenderFunction<keyof React.JSX.IntrinsicElements, CloseButtonRenderProps>` | - | Overrides the default DOM element with a custom render function.|

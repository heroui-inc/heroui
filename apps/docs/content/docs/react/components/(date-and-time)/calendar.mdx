...
- `.calendar-year-picker__trigger-text` - Heading text inside year picker trigger.
- `.calendar-year-picker__trigger-icon` - Indicator icon inside year picker trigger.

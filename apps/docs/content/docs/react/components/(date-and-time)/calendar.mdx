...
Calendar also exposes `Calendar.YearPickerTrigger` and `Calendar.YearPickerGrid` for an inline year-selection view.
...
`Calendar.YearPickerTrigger` and `Calendar.YearPickerGrid` provide an integrated year navigation pattern.
  ...
  return (
    <Calendar aria-label="Custom calendar" className="w-72 rounded-2xl border border-border bg-surface p-3 shadow-sm">
      <Calendar.Header className="pb-3">
        <Calendar.NavButton slot="previous" className="text-default-600" />
        <Calendar.Heading className="text-default-700" />
        <Calendar.NavButton slot="next" className="text-default-600" />
      </Calendar.Header>
      <Calendar.Grid>
        <Calendar.GridHeader>
          {(day) => <Calendar.HeaderCell>{day}</Calendar.HeaderCell>}
...
| `Calendar.YearPickerGrid` | Overlay year selection grid. |

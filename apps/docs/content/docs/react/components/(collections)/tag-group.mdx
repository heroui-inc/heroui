...
- `.tag--in-surface` - In-surface variant for use in surface components
- `.tag--on-form-field` - On-form-field variant for use within form components

#### Modifier Classes
- `.tag__remove-button--in-surface` - Remove button modifier for in-surface variant
...
| `variant` | `"default" \| "surface" \| "in-surface" \| "on-form-field"` | `"default"` | Visual variant of the tags |

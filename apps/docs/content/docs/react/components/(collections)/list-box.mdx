...
| `render` | `DOMRenderFunction<keyof React.JSX.IntrinsicElements, ListBoxItemIndicatorRenderProps>` | - | Overrides the default DOM element with a custom render function.|

...
The secondary variant removes the background container, giving the table a flat appearance with standalone rounded headers and transparent rows.
...
Cells can contain any React content including avatars, chips, buttons, and other components.

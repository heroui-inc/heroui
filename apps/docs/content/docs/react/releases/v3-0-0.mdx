...
HeroUI started as a React library with nice defaults and Framer Motion animations. v3 is a ground-up rewrite for React and React Native. New architecture, new styling system, 112+ components across both platforms.

## Overview

### React (Web)

75+ components covering forms, data display, navigation, overlays, feedback, layout, date and time, and color. Compound component architecture on [React Aria Components](https://react-aria.adobe.com/), styled with Tailwind CSS v4 and CSS variables. No runtime styles.

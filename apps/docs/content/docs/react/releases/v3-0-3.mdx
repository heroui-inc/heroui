---
title: v3.0.3
description: Apache 2.0 license, React Aria Components 1.17.0 Upgrade, useTheme hook, Table with expandable rows, DOM polymorphic render-prop API, and bug fixes.
github:
  pull: 6441
---
...
Patch release: Apache 2.0 license, React Aria Components 1.17.0 Upgrade, the `useTheme` hook for Vite and CRA apps, Table with expandable rows, a DOM polymorphic utility for render-prop element swaps, and bug fixes.

...
- `color`, `size`, `radius` - Use Tailwind CSS classes (`variant` exists in v3 as `primary` \| `secondary`)
...
5. **Styling**: `variant` simplified to `primary` \| `secondary`; `color`, `size`, `radius` removed - use Tailwind for more

...
8. **Ripple Removed**: No ripple effect in v3
9. **ButtonGroup Available**: See [ButtonGroup migration guide](/docs/react/migration/button-group)
10. **ClassNames Removed**: Use `className` prop

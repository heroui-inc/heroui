...
### v2: Basic ScrollShadow Component
...
### v3: Enhanced ScrollShadow Component
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ...
    <ScrollShadow variant="blur" className="max-h-[400px]">
      {/* Content with blur shadow effect */}
    </ScrollShadow>
    ```
  </Tab>
</Tabs>

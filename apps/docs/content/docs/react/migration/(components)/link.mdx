...
| `underline` | - | Removed (use Tailwind: `underline`, `hover:underline`, `no-underline`) |
...
- `underline` - Use Tailwind classes (`underline`, `hover:underline`, `no-underline`, `underline-offset-*`)

...
description: Step-by-step guide for migrating HeroUI v2 to v3 using phased migration approach
---
...
Phased migration is a structured approach to migrating from HeroUI v2 to v3. This method involves migrating all component code first, then switching dependencies, ensuring a clean transition.
...
- You can dedicate focused time to complete the migration
- You're comfortable working in a feature branch with a temporarily broken project
- You want a clean, all-at-once transition
- You prefer a simpler setup without managing two versions simultaneously
...
If you're using an AI assistant to help with migration, see the [Agent Migration Guide - Phased Migration](/docs/react/migration/agent-guide-phased) for instructions on how assistants should guide users through prompts.
...
Use this checklist to track your phased migration progress:
...
After completing the phased migration:

...
1. **`analyze-and-plan`**: Analyze the project to identify all HeroUI v2 components and create a full migration plan. First step in migration. No arguments required.
...
1. **Guide user to invoke `implement-migration` prompt**
   - Prompt includes instructions for full migration with checkpoints

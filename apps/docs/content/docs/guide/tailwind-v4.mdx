...
TailwindCSS v4 is now available! This guide will help you migrate your existing TailwindCSS v4 project to HeroUI.
...
2. Install the new version of HeroUI (The minimal supported version is `2.8.0`)
...
<PackageManagers
  commands={{
    ...
    yarn: "yarn install @heroui/react@latest",

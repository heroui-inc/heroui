...
<PackageManagers
  commands={{
    npm: "npm install @vezham/react framer-motion",
...
<PackageManagers
  commands={{
    npm: "npm install @vezham/theme @vezham/system framer-motion",
    yarn: "yarn add @vezham/theme @vezham/system framer-motion",
    pnpm: "pnpm add @vezham/theme @vezham/system framer-motion",
    bun: "bun add @vezham/theme @vezham/system framer-motion"
  }}
/>
...
<PackageManagers
  commands={{
    npm: "npm install @vezham/button",
    yarn: "yarn add @vezham/button",
    pnpm: "pnpm add @vezham/button",
    bun: "bun add @vezham/button"
  }}
/>
...
```js
// tailwind.config.js
const {heroui} = require("@vezham/theme");

/** @type {import('tailwindcss').Config} */
module.exports = {
  content: [
    // single component styles
    "./node_modules/@vezham/theme/dist/components/button.js",
    // or you can use a glob pattern (multiple component styles)
    './node_modules/@vezham/theme/dist/components/(button|snippet|code|input).js'
  ],
  theme: {
    extend: {},
  },

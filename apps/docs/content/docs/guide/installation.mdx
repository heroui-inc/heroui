...
<PackageManagers
  commands={{
    npm: "npm install @heroui/react @heroui/motion",
    yarn: "yarn add @heroui/react @heroui/motion",
    pnpm: "pnpm add @heroui/react @heroui/motion",
    bun: "bun add @heroui/react @heroui/motion"
  }}
/>
...
<PackageManagers
  commands={{
    npm: "npm install @heroui/theme @heroui/system @heroui/motion",
    yarn: "yarn add @heroui/theme @heroui/system @heroui/motion",
    pnpm: "pnpm add @heroui/theme @heroui/system @heroui/motion",
    bun: "bun add @heroui/theme @heroui/system @heroui/motion"
  }}
/>

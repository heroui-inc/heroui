...
- Updated CSS class `.tabs__list-wrapper` → `.tabs__list-container`
- Updated data attribute `data-slot="tabs-list-wrapper"` → `data-slot="tabs-list-container"`
- Simple migration via global find and replace

[Read full release notes →](/docs/changelog/v3-0-0-alpha-36)

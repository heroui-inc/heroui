...
- **(Breaking change)**: Migrated all compound components from dot notation to named exports for React Server Components compatibility
- All 16 compound components affected: Accordion, Alert, Avatar, Card, Disclosure, DisclosureGroup, Fieldset, Kbd, Link, Popover, RadioGroup, Slider, Switch, SwitchGroup, Tabs, and Tooltip
- Improved tree-shaking and TypeScript support
- Updated all documentation to reflect new import patterns

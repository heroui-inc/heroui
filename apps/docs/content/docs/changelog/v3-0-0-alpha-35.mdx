...
- `DisclosureGroup` → `DisclosureGroup.Root`
...
|-----------|---------------------|---------------------|
| **Accordion** | `<Accordion>`, `<AccordionItem>` | `<Accordion.Root>`, `<Accordion.Item>` |
| **Alert** | `<Alert>`, `<AlertIcon>` | `<Alert.Root>`, `<Alert.Icon>` |
| **Avatar** | `<Avatar>`, `<AvatarImage>` | `<Avatar.Root>`, `<Avatar.Image>` |
| **Card** | `<Card>`, `<CardHeader>` | `<Card.Root>`, `<Card.Header>` |
| **Disclosure** | `<Disclosure>`, `<DisclosureTrigger>` | `<Disclosure.Root>`, `<Disclosure.Trigger>` |
| **Fieldset** | `<Fieldset>`, `<FieldsetLegend>` | `<Fieldset.Root>`, `<Fieldset.Legend>` |
| **Kbd** | `<Kbd>`, `<KbdKey>` | `<Kbd.Root>`, `<Kbd.Key>` |
| **Link** | `<Link>`, `<LinkIcon>` | `<Link.Root>`, `<Link.Icon>` |
| **Popover** | `<Popover>`, `<PopoverTrigger>` | `<Popover.Root>`, `<Popover.Trigger>` |
| **RadioGroup** | `<RadioGroup>`, `<Radio>` | `<RadioGroup.Root>`, `<RadioGroup.Item>` |
| **Slider** | `<Slider>`, `<SliderTrack>` | `<Slider.Root>`, `<Slider.Track>` |

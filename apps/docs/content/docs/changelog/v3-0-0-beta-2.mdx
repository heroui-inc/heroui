---
title: v3.0.0-beta.2
description: Four new components (AlertDialog, ComboBox, Dropdown, Modal), Select API improvements, and component refinements.
---
...
This release introduces four essential new components, improves the Select component API, and includes various refinements and bug fixes.
...
This release introduces **4 new** essential components:

---
title: v3.0.0-beta.3
description: Seven new components (ButtonGroup, DateField, ErrorMessage, ScrollShadow, SearchField, TagGroup, TimeField), style fixes for form components, and breaking change for AlertDialog and Modal backdrop variants.
github:
  pull: 5923
---
...
This release introduces seven new components, fixes disabled state styling for form components, and includes a breaking change for better semantic clarity in AlertDialog and Modal backdrop variants.

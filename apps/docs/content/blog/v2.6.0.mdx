...
<PackageManagers
  commands={{
    npm: "npm install @vezham/react@latest framer-motion@latest",
    pnpm: "pnpm add @vezham/react@latest framer-motion@latest",
    yarn: "yarn add @vezham/react@latest framer-motion@latest",
    bun: "bun add @vezham/react@latest framer-motion@latest",
  }}
/>
...
```diff-tsx
// Before
- "./node_modules/@vezham/theme/dist/components/circular-progress.js";

// After
+ "./node_modules/@vezham/theme/dist/components/progress.js";
```
...
- Synced API from heroui-cli v0.3.5 by [@winchesHe](https://github.com/winchesHe) in [PR #4173](https://github.com/vezham/heroui/pull/4173)

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 2d612d646d14b13df299e38ac859fd21)
...
interface __BaseEnv_CloudflareEnv {
	...
	LOOPS_API_ENDPOINT: string;
	LOOPS_API_KEY: string;
	FEATUREBASE_API_ENDPOINT: string;
	FEATUREBASE_API_KEY: string;
	WORKER_SELF_REFERENCE: Fetcher /* heroui-docs */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_POSTHOG_KEY" | "NEXT_PUBLIC_POSTHOG_HOST" | "IMPORT_API_KEY" | "CHAT_API_URL" | "CHAT_URL" | "NEXT_PUBLIC_APP_ENV" | "NEXT_PUBLIC_CDN_URL" | "LOOPS_API_ENDPOINT" | "LOOPS_API_KEY" | "FEATUREBASE_API_ENDPOINT" | "FEATUREBASE_API_KEY">> {}
}

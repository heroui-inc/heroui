...
export function WithAvatar() {
  return (
    <div className="flex flex-col gap-4 md:flex-row">
      <CardRoot className="w-[200px] gap-2">
        <img
        ...
        <CardFooter className="flex gap-2">
          <AvatarRoot aria-label="Martha's profile picture" className="size-5" role="img">
            <AvatarImage
              alt="Martha's avatar"
      ...
      <CardRoot className="w-[200px] gap-2">
        ...
        <CardFooter className="flex gap-2">
          <AvatarRoot aria-label="John's profile picture" className="size-5" role="img">
            <AvatarImage

...
export function DemoComponents() {
  return (
    <div className="mx-auto grid grid-cols-1 gap-8 min-[1200px]:grid-cols-3! md:grid-cols-2 lg:grid-cols-[1fr_auto_1fr]">
      {/* Left */}
      <div className="order-2 flex max-w-[360px] flex-col items-center gap-10 md:order-2">
        <TextfieldDemo />
        <SelectDemo />
        <UIComponentsDemo />
        <SliderDemo />
      ...
      {/* Center */}
      <div className="order-1 flex max-w-[360px] flex-col items-center gap-10 md:order-1">
        <AvatarGroupDemo />
        <InputOTPDemo />
        <ButtonsDemo />
        <XProfileDemo />
      ...
      {/* Right */}
      <div className="order-3 col-span-1 grid grid-cols-1 grid-rows-2 justify-items-center gap-8 md:col-span-2 md:grid-cols-2 md:grid-rows-[auto_auto] lg:col-span-1 lg:max-w-[360px] lg:grid-cols-1">

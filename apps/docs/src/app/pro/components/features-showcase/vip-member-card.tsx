    ...
    <div className="absolute top-[942px] left-[896px] h-[288px] w-[320px] overflow-clip rounded-[24px] border border-solid border-[#dedee0]">
      ...
      <div className="absolute top-[39px] left-[126px] flex size-[12px] items-center justify-center">
        <div className="flex-none -scale-y-100 rotate-180">
          <div className="relative size-[12px]" data-name="mynaui:chat-solid">
            <svg
      ...
      >
        <div className="flex-none rotate-[9.94deg]">
          <div className="relative size-[13.996px]">
            ...
            <div
              className="absolute top-[3.5px] right-[24.99%] left-[25.01%] aspect-[24/24] overflow-clip opacity-30"
              data-name="token:zap"
            >
              <div className="absolute inset-[12.51%_26.55%_12.49%_26.56%]" data-name="Vector">
                <svg
                  className="absolute block size-full"
                  fill="none"
                  preserveAspectRatio="none"
                  viewBox="0 0 3.28105 5.24861"
                >
                  <path
                    d="M1.97646 1.8044V0.207095C1.98433 0.167731 1.96946 0.0741325 1.847 0.0166901C1.74028 -0.0334625 1.62393 0.0408917 1.58894 0.0887117C1.0568 0.939266 0.0630781 2.72785 0.0242972 2.81795C-0.0249807 2.93138 0.00855175 3.00194 0.0552054 3.05413C0.089904 3.09321 0.172714 3.11653 0.217035 3.11653H1.29736L1.06701 5.07016C1.06992 5.11535 1.10783 5.21303 1.23146 5.24277C1.35538 5.27222 1.44053 5.183 1.46764 5.13489L3.23378 2.14614C3.25944 2.10677 3.3125 2.00209 3.25594 1.90995C3.23435 1.87582 3.20406 1.84805 3.16819 1.8295C3.13232 1.81095 3.09216 1.80229 3.05183 1.8044H1.97646Z"
                    fill="var(--fill-0, #18181B)"
                    id="Vector"
                  />
                </svg>
      ...
      <div className="absolute top-[139px] left-[87px] h-[36px] w-[144px]">
        <div className="absolute top-[4px] left-[120px] size-[13.996px]">
          <div className="absolute top-[0.58px] left-[0.58px] size-[12.83px]">
            <div className="absolute inset-[2.81%_6.7%]">
              <svg
                className="block size-full"
              ...
              >
                <path
                  d="M4.3891 0.31252C5.11084 -0.104173 6.00005 -0.104174 6.72179 0.31252L9.94455 2.17318C10.6663 2.58988 11.1109 3.35996 11.1109 4.19335V7.91467C11.1109 8.74806 10.6663 9.51814 9.94455 9.93483L6.72179 11.7955C6.00005 12.2122 5.11084 12.2122 4.3891 11.7955L1.16634 9.93483C0.444608 9.51814 0 8.74806 0 7.91467V4.19335C0 3.35996 0.444607 2.58988 1.16634 2.17318L4.3891 0.31252Z"
                  fill="url(#paint0_linear_1_13380)"
                  id="Polygon 3"
                />
                <defs>
                  <linearGradient
                    gradientUnits="userSpaceOnUse"
                    id="paint0_linear_1_13380"
                    x1="5.55545"
                    x2="5.55545"
                    y1="-0.360867"
                    y2="12.4689"
          ...
          <div
            className="absolute top-[3.5px] right-[24.99%] left-[25.01%] aspect-[24/24] overflow-clip"
            data-name="token:zap"
          >
            <div className="absolute inset-[12.53%_26.54%_12.47%_26.57%]" data-name="Vector">
              <svg
                className="absolute block size-full"
                fill="none"
                preserveAspectRatio="none"
        ...
        <div className="absolute top-0 left-0 size-[36px] overflow-clip rounded-[244.8px] opacity-90">
          <div
      ...
      <div className="absolute top-[183px] left-[87px] h-[36px] w-[144px]">
        <div className="absolute top-[4px] left-[120px] size-[14px]">
          <div className="absolute top-[0.58px] left-[0.58px] size-[12.833px]">
            <div className="absolute inset-[2.81%_6.7%]">
              <svg
                className="block size-full"
                fill="none"
                preserveAspectRatio="none"
                viewBox="0 0 11.114 12.1114"
              >
                <path
                  d="M4.39033 0.312607C5.11227 -0.104203 6.00173 -0.104202 6.72366 0.312608L9.94733 2.17379C10.6693 2.5906 11.114 3.3609 11.114 4.19452V7.91688C11.114 8.7505 10.6693 9.5208 9.94733 9.93761L6.72366 11.7988C6.00173 12.2156 5.11227 12.2156 4.39033 11.7988L1.16667 9.93761C0.44473 9.5208 0 8.7505 0 7.91688V4.19452C0 3.3609 0.444731 2.5906 1.16667 2.17379L4.39033 0.312607Z"
                  fill="url(#paint0_linear_1_13491)"
                  id="Polygon 3"
                />
                <defs>
                  <linearGradient
                    gradientUnits="userSpaceOnUse"
                    id="paint0_linear_1_13491"
                    x1="5.557"
                    x2="5.557"
                    y1="-0.360968"
                    y2="12.4724"
                  >
                    <stop stopColor="#7538F8" />
                    <stop offset="1" stopColor="#F690EC" />
                  </linearGradient>
                </defs>
              </svg>
            </div>
          ...
          <div
            className="absolute top-[3.5px] right-1/4 left-1/4 aspect-[24/24] overflow-clip"
            data-name="token:zap"
          >
            <div className="absolute inset-[12.5%_26.55%_12.5%_26.56%]" data-name="Vector">
              <svg
                ...
                fill="none"
                preserveAspectRatio="none"
                viewBox="0 0 3.28197 5.25007"
              >
                <path
                  d="M1.97701 1.8049V0.207153C1.98489 0.167778 1.97001 0.0741531 1.84751 0.0166948C1.74076 -0.0334719 1.62439 0.0409031 1.58939 0.0887365C1.0571 0.939528 0.0630957 2.72861 0.024304 2.81874C-0.0249877 2.93219 0.00855413 3.00278 0.0552208 3.05499C0.0899291 3.09407 0.172762 3.1174 0.217096 3.1174H1.29772L1.0673 5.07157C1.07022 5.11678 1.10814 5.21449 1.2318 5.24424C1.35576 5.27369 1.44093 5.18445 1.46805 5.13632L3.23468 2.14674C3.26035 2.10736 3.31343 2.00265 3.25685 1.91049C3.23525 1.87635 3.20496 1.84857 3.16908 1.83001C3.1332 1.81146 3.09302 1.80279 3.05268 1.8049H1.97701Z"
                  fill="var(--fill-0, white)"
                  id="Vector"
                />
              </svg>
      ...
      <div className="absolute top-[227px] left-[87px] h-[36px] w-[144px]">
          ...
          <div className="absolute top-[0.58px] left-[0.58px] size-[12.833px]">
            <div className="absolute inset-[2.81%_6.7%]">
              ...
              >
                <path
                  d="M4.39033 0.312607C5.11227 -0.104203 6.00173 -0.104202 6.72366 0.312608L9.94733 2.17379C10.6693 2.5906 11.114 3.3609 11.114 4.19452V7.91688C11.114 8.7505 10.6693 9.5208 9.94733 9.93761L6.72366 11.7988C6.00173 12.2156 5.11227 12.2156 4.39033 11.7988L1.16667 9.93761C0.44473 9.5208 0 8.7505 0 7.91688V4.19452C0 3.3609 0.444731 2.5906 1.16667 2.17379L4.39033 0.312607Z"
                  fill="url(#paint0_linear_1_13493)"
                  id="Polygon 3"
                />
                <defs>
                  <linearGradient
                    gradientUnits="userSpaceOnUse"
                    id="paint0_linear_1_13493"
                    x1="5.557"
                    x2="5.557"
                    y1="-0.360968"
                    y2="12.4724"
        ...
        <div className="absolute top-0 left-0 size-[36px] overflow-clip rounded-[244.8px] opacity-80">
          <div
            className="absolute top-0 left-0 size-[36px] rounded-[18px]"
            style={{
              backgroundImage:
      ...
      <div
        className="absolute top-[31px] left-[151px] size-[16px] overflow-clip opacity-30"
        data-name="logo-discord"
      >
        <div
          className="absolute top-0 bottom-0 left-1/2 aspect-[24/24] -translate-x-1/2 overflow-clip"
          data-name="discord"
        >
          <div className="absolute inset-[16.67%_6.24%_16.65%_6.26%]" data-name="Vector">
            <svg
              className="absolute block size-full"
              fill="none"
              preserveAspectRatio="none"

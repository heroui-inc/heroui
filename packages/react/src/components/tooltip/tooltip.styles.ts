...
export const tooltipBase = [
  ...
  /* Entering */
  // base
  "animate-in zoom-in-90 fade-in-0 ease-spring duration-400",
  // top
  ...
  /* Exiting */
  // base
  "data-exiting:animate-out data-exiting:fade-out data-exiting:zoom-out-95 data-exiting:duration-150 data-exiting:ease",
  /* Arrow */

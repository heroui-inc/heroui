  ...
  variants: {
    ...
    disableAnimation: {
      ...
      false: {
        ...
        base: [
          "data-[toast-exiting=true]:transform",
          "data-[toast-exiting=true]:delay-100",
          "data-[toast-exiting=true]:data-[placement=bottom-right]:translate-x-28",
          "data-[toast-exiting=true]:data-[placement=bottom-left]:-translate-x-28",
          "data-[toast-exiting=true]:data-[placement=bottom-center]:translate-y-28",
          "data-[toast-exiting=true]:data-[placement=top-right]:translate-x-28",
          "data-[toast-exiting=true]:data-[placement=top-left]:-translate-x-28",
          "data-[toast-exiting=true]:data-[placement=top-center]:-translate-y-28",
          "data-[toast-exiting=true]:opacity-0",
          "data-[toast-exiting=true]:duration-200",
        ],
      },
    },
    shadow: {

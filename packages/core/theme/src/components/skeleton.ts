...
const skeleton = tv({
  slots: {
    base: [
      ...
      // state
      "vg-data-[loaded=true]:pointer-events-auto",
      "vg-data-[loaded=true]:overflow-visible",
      "vg-data-[loaded=true]:!bg-transparent",
      "vg-data-[loaded=true]:before:opacity-0 data-[loaded=true]:before:-z-10 data-[loaded=true]:before:animate-none",
      "vg-data-[loaded=true]:after:opacity-0",
    ],

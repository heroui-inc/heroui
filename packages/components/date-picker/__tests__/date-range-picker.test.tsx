...
describe("DateRangePicker", () => {
  describe("DateRangePicker with HeroUIProvider context", () => {
    it("should inherit labelPlacement from HeroUIProvider", () => {
      const {container} = render(
        <HeroUIProvider labelPlacement="outside">
          <DateRangePicker label="Test DateRangePicker" />
        </HeroUIProvider>,
      );
    ...
    it("should prioritize labelPlacement prop over HeroUIProvider context", () => {
      const {container} = render(
        <HeroUIProvider labelPlacement="outside">
          <DateRangePicker label="Test DateRangePicker" labelPlacement="inside" />
        </HeroUIProvider>,
      );

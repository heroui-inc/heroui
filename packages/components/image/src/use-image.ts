import type {ImageVariantProps, SlotsToClasses, ImageSlots} from "@vezham/theme";
...
import {image} from "@vezham/theme";
...
import {useImage as useImageBase} from "@vezham/use-image";

import type {SnippetVariantProps, SnippetSlots, SlotsToClasses} from "@vezham/theme";

import {snippet} from "@vezham/theme";
...
import {useClipboard} from "@vezham/use-clipboard";

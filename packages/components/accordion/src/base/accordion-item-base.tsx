import type {AccordionItemVariantProps, AccordionItemSlots, SlotsToClasses} from "@vezham/theme";

import {As} from "@vezham/system";
import {ItemProps, BaseItem} from "@vezham/aria-utils";
